...
r = 0.02        # Interest rate on loans (Modellen antar fast rentesats)
...
# ODE system
def dFdt(t, F, alpha, beta, U, P, r, L0, A0):
...
result = solve_ivp(dFdt, t_span, [F0], args=(alpha, beta, U, P, r, L0, A0), t_eval=t_eval)

# Extracting the solution
F_solution = result.y[0]
...
plt.plot(years, F_solution, label='Forbruk [kr]')
